...
export const ImpactStats = ({ stats }) => {
  return (
    <div className="bg-primary text-white section-padding relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-heading font-bold mb-4">
            Our Impact in <span className="text-secondary-light">Numbers</span>
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-y-12 gap-x-8">
          {stats.map((stat, index) => (
            <div key={index} className="text-center group">
              <div className="text-4xl md:text-5xl font-heading font-bold text-secondary-light mb-3 group-hover:scale-110 transition-transform duration-300 inline-block">
                {stat.animated ? (
                  <ImpactCounter
                    end={stat.value}
                    suffix={stat.suffix || ""}
              ...
              <div className="text-xs md:text-sm font-bold text-gray-300 uppercase tracking-[0.2em]">
                {stat.label}
              </div>
            </div>
          ))}
